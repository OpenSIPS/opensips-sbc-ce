...
# Attention : advanced options !!
 ...
 $module_id = "dialplan_dispatcher_did";
 $custom_config[$module_id] = array ();

 // a custom global name for the tool
 $custom_config[$module_id]['custom_name'] = "DID Mappings";
...
$custom_config[$module_id][0]['custom_table'] = "dialplan_did";
...
$custom_config[$module_id][0]['custom_table_column_defs'] = array (
	...
	"match_exp"	=> 	array (
		"header" 			=> "Dialled Number",
		"type"				=> "text",
		"key"				=> NULL,
		"is_optional"			=> "n",
		"tip"				=> "The dialled number (DID) used to match inbound calls from PSTN.",
		"validation_regex" 		=> ".*",
		"show_in_add_form" 		=> true,
		"show_in_edit_form"		=> true,
		"searchable" 			=> true,
	...
	"subst_exp" 	=> 	array (
		"header" 			=> "Substitution Expression",
		"type"				=> "text",
		"tip"				=> "A regular expression pattern that indicates the expresion that will be replaced.",
		"show_in_add_form" 		=> true,
		"show_in_edit_form"		=> true,
		"searchable" 			=> true,
		"validation_regex" 		=> ".*",
	...
	"repl_exp"	=> 	array (
		"header" 			=> "Replacement Expression",
		"type"				=> "text",
		"key"				=> NULL,
		"tip"				=> "The regular expression patter used to replace DID. Format is number[@domain]. If domain is missing, the destination domain will be used.",
		"is_optional"			=> "y",
		"show_in_add_form" 		=> true,
		"show_in_edit_form"		=> true,
		"searchable" 			=> true,
	...
	"attrs"	=> 	array (
		...
		"type"				=> "combo",
		"key"				=> NULL,
		"tip"				=> "The Servers Group that should be used for the matched dialled number.",
		"is_optional"			=> "n",
		"show_in_add_form" 		=> true,
		"show_in_edit_form"		=> true,
		"searchable" 			=> true,
 ...
 $custom_config[$module_id][0]['custom_mi_command'] = "dp_reload did_map";
